...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new OpenApiDefinition.EmployeesControllerApi();
  });
  ...
  describe('EmployeesControllerApi', function() {
    ...
    describe('editEmployee', function() {
      it('should call editEmployee successfully', function(done) {
        //uncomment below and update the code to test editEmployee
        //instance.editEmployee(function(error) {
        //  if (error) throw error;
        //expect().to.be();
        //});
        done();
    ...
    describe('searchEmployees', function() {
      it('should call searchEmployees successfully', function(done) {
        //uncomment below and update the code to test searchEmployees
        //instance.searchEmployees(function(error) {
        //  if (error) throw error;
        //expect().to.be();
        //});
        done();
